        ...
        <div class="row">
            ...
            <div class="evaluation-form">
                ...
                <form id="evaluationForm" action="submit_evaluation.php" method="post">
                    <!-- Include hidden fields for teacher_id and subject_id -->
                    <input type="hidden" name="teacher_id" value="<!-- Dynamic teacher ID -->">
                    <input type="hidden" name="subject_id" value="<!-- Dynamic subject ID -->">
                    
                    <div id="dynamicFields">
                        <!-- Form fields generated by fetch_questions.php -->
